...
int main(int argc, char *argv[]) {
  ...
  switch (threads) {
    case 1024:
      volume_calculate_gpu<1024> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<1024> <<<1,threads>>>(gpu_result, sum_threads);
      break;
    case 512:
      volume_calculate_gpu<512> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<512> <<<1,threads>>>(gpu_result, sum_threads);
      break;
    case 256:
      volume_calculate_gpu<256> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<256> <<<1,threads>>>(gpu_result, sum_threads);
      break;
    case 128:
      volume_calculate_gpu<128> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<128> <<<1,threads>>>(gpu_result, sum_threads);
      break;
    case 64:
      volume_calculate_gpu<64> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<64> <<<1,threads>>>(gpu_result, sum_threads);
      break;
    case 32:
      volume_calculate_gpu<32> <<<blocks,threads>>>(gpu_mesh, gpu_result, reduce);
      cudaDeviceSynchronize();
      sum_calculate<32> <<<1,threads>>>(gpu_result, sum_threads);
      break;
  }
  cudaDeviceSynchronize();
